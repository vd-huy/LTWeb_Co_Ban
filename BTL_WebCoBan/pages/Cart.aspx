...
<html lang="en">
    ...
    <body>
            ...
            <div class="cart__content">
                <div class="cart__item">
                    ...
                    <h4 class="cart__item--total">
                        Bạn đang có
                        <span class="count__product">1 sản phẩm</span>
                        trong giỏ hàng</h4>
                    ...
                    <div class="cart__product--list">
                        <div class="cart__product--item">
                            <div class="product__item--detail">
                                <img
                                    src="https://product.hstatic.net/200000263355/product/z5276829297780_f8f840869d30e72779820ae0fe791e29_923c154982994542a424be103ee34f3f_medium.jpg"
                                    alt="cart product">

                                <div>
                                    <h5 class="product__item--name">Kệ sắt tai
                                        mèo
                                        chén sứ đôi</h5>

                                    <h5
                                        class="product__item--price">675,000₫</h5>
                                </div>
                            </div>

                            <div class="product__item--action">
                                <div class="item__count">
                                    <button class="item__count--icon minus"><i
                                            class="fa-solid fa-minus"></i></button>
                                    <span class="count">1</span>
                                    <button class="item__count--icon plus"><i
                                            class="fa-solid fa-plus"></i></button>
                                </div>

                                <button class="action__delete">Xóa</button>
                            </div>
                        </div>
                        <div class="cart__product--item">
                            <div class="product__item--detail">
                ...
                <div class="cart__total">
                    ...
                    <div class="total__price">
                        Tổng tiền:
                        <span
                            style="font-size: 24px; color: red;float: right; ">225000₫</span>
                    </div>
        ...
        <script>
            ...
            const countProduct = document.querySelector(".count__product");
            const countCart = document.querySelector(".header__controls--cart");

            let numArray = Array(count.length).fill(1);

            window.onload =  function() {
                let sumArr = numArray.reduce((a,b)=>{
                        return a+b
                    },0);
                countProduct.innerHTML = ` ${sumArr} sản phẩm`;

                countCart.setAttribute("data-total", sumArr);
            }
            
            plus.forEach((item,index)=>{
                item.addEventListener("click",()=>{
                    numArray[index]++;
                    count[index].innerText=numArray[index];
                    let sumArr = numArray.reduce((a,b)=>{
                        return a+b
                    },0);
                    countProduct.innerHTML = ` ${sumArr} sản phẩm`;
